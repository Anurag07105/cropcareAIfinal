...
const Login = () => {
  ...
  const translations = {
    en: {
      ...
      subtitle: "Sign in to access disease detection, AI chat, and community",
      signInTab: "Sign In",
      signUpTab: "Sign Up",
      name: "Full Name",
      ...
      checkEmail:
        "Check your email for a verification link, then come back and sign in.",
    },
    hi: {
      title: "क्रॉपकेयर AI में आपका स्वागत है",
      subtitle: "रोग पहचान, AI चैट और समुदाय तक पहुँचने के लिए साइन इन करें",
      signInTab: "साइन इन",
      signUpTab: "साइन अप",
      name: "पूरा नाम",
      ...
      checkEmail:
        "सत्यापन लिंक के लिए अपना ईमेल जांचें, फिर वापस आकर साइन इन करें।",
    },
  };
      ...
      <div className="flex items-center justify-center min-h-[calc(100vh-4rem)] px-4 py-8">
        <Card className="w-full max-w-md shadow-strong">
          ...
          <CardContent>
            ...
            {info && (
              <div className="flex items-center gap-2 p-3 mb-4 rounded-md bg-green-500/10 text-green-700 text-sm">
